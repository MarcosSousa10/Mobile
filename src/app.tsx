...
const TabNavigation = () => {
  ...
  return (
      ...
      >
        ...
        <Tab.Screen name="Orders" component={Home} options={{title: 'Pedidos', headerShown: false}}/>
        <Tab.Screen name="Settings" component={Home} options={{title: 'Perfil', headerShown: false}}/>
      </Tab.Navigator>
  );
};
const App = () => {
